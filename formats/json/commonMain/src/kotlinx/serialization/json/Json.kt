...
public class JsonBuilder internal constructor(json: Json) {
    ...
    /**
     * Specifies whether `null` values should be printed for nullable properties and must be present in JSON object
     * during decoding.
     *
     * When this flag is disabled null fields with `null` value not printed while encoding and during decoding,
     * the absence of a field value is read as `null` for nullable properties without a default value.
     *
     * `false` by default.
     */
