...
internal class JsonElementMarker(descriptor: SerialDescriptor) {
    private val origin: ElementMarker = ElementMarker(descriptor, ::readElementIfAbsence)
    ...
    private fun readElementIfAbsence(descriptor: SerialDescriptor, index: Int): Boolean {
