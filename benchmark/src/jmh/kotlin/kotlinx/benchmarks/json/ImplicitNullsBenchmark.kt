...
open class ImplicitNullsBenchmark {
    ...
    fun decodeNoNullsImplicit() {
        jsonImplicitNulls.decodeFromString<Values>(jsonNoNulls)
    }
    ...
    fun decodeNullsImplicit() {
        jsonImplicitNulls.decodeFromString<Values>(jsonWithNulls)
    }

    @Benchmark
    fun decodeAbsenceImplicit() {
        jsonImplicitNulls.decodeFromString<Values>(jsonWithAbsence)
    }
    ...
    fun encodeNullsImplicit() {
        jsonImplicitNulls.encodeToString(valueWithNulls)
    }
}
